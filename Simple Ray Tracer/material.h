...
std::random_device rnd_device_material;
std::mt19937 engine_generator_material(rnd_device_material());
std::uniform_real_distribution<> rnd_dist_material(0, 1);
...
public:
	...
	virtual bool scatter(const ray& r_in, const hit_record& rec, vec3& attenuation, ray& scattered) const {
		...
		if (refract(r_in.direction(), outward_normal, ni_over_nt, refracted))
			...
			reflect_prob = 1.0;
		if (rnd_dist_material(engine_generator_material) < reflect_prob)
